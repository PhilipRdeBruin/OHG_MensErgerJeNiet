...
function init_spelbord(kleur1) {
    ...
    case "blauw":
        ...
        geel = [[1,1,30],[1,2,30],[2,1,30],[2,2,30],[5,1,50,11,"_A"],[6,2,30,111,"-a"],[6,3,30,112,"-b"],[6,4,30,133,"-c"],[6,5,30,134,"-d"]];
        groen = [[1,10,30],[1,11,30],[2,10,30],[2,11,30],[1,7,50,21,"_A"],[2,6,30,121,"-a"],[3,6,30,122,"-b"],[4,6,30,123,"-c"],[5,6,30,124,"-d"]];
        rood = [[10,10,30],[10,11,30],[11,10,30],[11,11,30], [7,11,50,31,"_A"],[6,7,30,134,"-d"],[6,8,30,113,"-c"],[6,9,30,112,"-b"],[6,10,30,111,"-a"]];
        ...
        break;
    case "geel":
        geel = [[10,1,30],[10,2,30],[11,1,30],[11,2,30], [11,5,50,11,"_A"],[7,6,30,134,"-d"],[8,6,30,133,"-c"],[9,6,30,132,"-b"],[10,6,30,131,"-a"]];
        groen = [[1,1,30],[1,2,30],[2,1,30],[2,2,30],[5,1,50,21,"_A"],[6,2,30,"-a"],[6,3,30,"-b"],[6,4,30,"-c"],[6,5,30,"-d"]];
        rood = [[1,10,30],[1,11,30],[2,10,30],[2,11,30],[1,7,50,"_A"],[2,6,30,"-a"],[3,6,30,"-b"],[4,6,30,"-c"],[5,6,30,"-d"]];
        blauw = [[10,10,30],[10,11,30],[11,10,30],[11,11,30], [7,11,50,"_A"],[6,7,30,"-d"],[6,8,30,"-c"],[6,9,30,"-b"],[6,10,30,"-a"]];
        ...
        break;
    case "groen":
        groen = [[10,1,30],[10,2,30],[11,1,30],[11,2,30], [11,5,50,"_A"],[7,6,30,"-d"],[8,6,30,"-c"],[9,6,30,"-b"],[10,6,30,"-a"]];
        rood = [[1,1,30],[1,2,30],[2,1,30],[2,2,30],[5,1,50, "_A"],[6,2,30,"-a"],[6,3,30,"-b"],[6,4,30,"-c"],[6,5,30,"-d"]];
        blauw = [[1,10,30],[1,11,30],[2,10,30],[2,11,30],[1,7,50,"_A"],[2,6,30,"-a"],[3,6,30,"-b"],[4,6,30,"-c"],[5,6,30,"-d"]];
        geel = [[10,10,30],[10,11,30],[11,10,30],[11,11,30], [7,11,50,"_A"],[6,7,30,"-d"],[6,8,30,"-c"],[6,9,30,"-b"],[6,10,30,"-a"]];
        ...
        break;
    case "rood":
        rood = [[10,1,30],[10,2,30],[11,1,30],[11,2,30], [11,5,50,"_A"],[7,6,30,"-d"],[8,6,30,"-c"],[9,6,30,"-b"],[10,6,30,"-a"]];
        blauw = [[1,1,30],[1,2,30],[2,1,30],[2,2,30],[5,1,50, "_A"],[6,2,30,"-a"],[6,3,30,"-b"],[6,4,30,"-c"],[6,5,30,"-d"]];
        geel = [[1,10,30],[1,11,30],[2,10,30],[2,11,30],[1,7,50,"_A"],[2,6,30,"-a"],[3,6,30,"-b"],[4,6,30,"-c"],[5,6,30,"-d"]];
        groen = [[10,10,30],[10,11,30],[11,10,30],[11,11,30], [7,11,50,"_A"],[6,7,30,"-d"],[6,8,30,"-c"],[6,9,30,"-b"],[6,10,30,"-a"]];
